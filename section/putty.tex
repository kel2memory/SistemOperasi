...
Secara keseluruhan, kata PuTTY masih tidak memiliki penjelasan. Tetapi kata "tty" adalah nama untuk terminal pada sistem operasi Unix.
...
\subsection {Cara setting Inject dengan putty} 

putty umum untuk jarak jauh atau server mengrolrol, misalnya, server VPS mengrolrol karena jika kita menggunakan putty maka prosesnya sangat besar dan mudah dibandingkan dengan server perangkat lain. Dan sekarang ada cara untuk Anda yang ingin dapat mengontrol server dengan putty tanpa memasang pulsa atau kuota. Cara ini sangat mudah, terutama bagi mereka yang suka menggunakan Secure Shell akan sangat mudah.

Menggabungkan putty dengan suntikan disamakan dengan membahas jalan kosong ke jalan yang padat. Di mana kami dapat menghubungkan server dengan kartu tanpa kredit dan kuota. Sebagai alternatif saya mendesain tutorial sebagai berikut.
