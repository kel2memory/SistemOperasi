...
Definisi sederhana dari fungsi aplikasi PuTTY adalah Anda menjalankan PuTTY di OS Windows, dan dapat digunakan untuk menghubungkan (misalnya) mesin Unix. Aplikasi Putty membuka Jendela. Kemudian, apa yang diketik di jendela yang dikirim langsung ke mesin Unix, dan semua tanggapan dari OS Unix akan dikirim kembali ditampilkan di jendela Anda. Jadi Anda dapat bekerja pada mesin Unix seolah-olah Anda berada di konsol, padahal sebenarnya tidak ..
Sebelum versi 0.58, tiga rilis berturut-turut (0,55-0,57) dibuat untuk memperbaiki lubang keamanan aplikasi PuTTY yang signifikan di versi sebelumnya, beberapa aplikasi bug PuTTY bahkan memungkinkan klien untuk masuk ke server tanpa otentikasi terlebih dahulu. Versi 0,58, dirilis pada bulan April 2005, berisi beberapa fitur baru,